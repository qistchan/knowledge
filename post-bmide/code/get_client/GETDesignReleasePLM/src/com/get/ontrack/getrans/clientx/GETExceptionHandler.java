 ...
 */
public class GETExceptionHandler implements ExceptionHandler
{
    /*
     * (non-Javadoc)
     *
    ...
    public void handleException(InternalServerException ise)
    {
        ...
        System.out.println("*****");
        System.out
                .println("Exception caught in com.get.clientx.GETExceptionHandler.handleException(InternalServerException).");
