        ...
        try
        {
            ...
            switch(propType)
            {
                ...
                case PropertyDescription.CLIENT_PROP_TYPE_float:
                    compareResult = mo1.getPropertyObject(attrName).getFloatValue() < mo2.getPropertyObject(attrName).getFloatValue() ? -1 : 
                    mo1.getPropertyObject(attrName).getFloatValue() > mo2.getPropertyObject(attrName).getFloatValue()? 1 : 0;
                    break;
