...
import com.ge.transportation.plm.mfg.ui.CreateGetOperatorItem;
 ...
 */
public class CreateGetOperatorHandler extends AbstractHandler {
	/**
	 * The constructor.
	 */
	public CreateGetOperatorHandler() {
	}
		...
		try {
			...
			if((null != selectedComponents) && (selectedComponents.length == 1)) {
				...
				if((selectedComponents[0] instanceof  TCComponentFolder) || (selectedComponents[0] instanceof  TCComponentBOMLine)) {
					...
					CreateGetOperatorItem createOperator = new CreateGetOperatorItem(window, selectedComponents);
					createOperator.createGetOperator();
				} else {
