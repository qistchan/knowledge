...
<div class="row-content padding-bottom50">
	<div class="col-md-12 padding-top20">
		...
		<div class="col-md-2 noPadding" style="width:150px;">
			<select  data-style="btn-primary" data-live-search="true" id="projectsDropDownEdit" data-width="130px">
		...
		<div class="col-md-1 noPadding">
			&nbsp;<button type="button" class="btn btn-success projectInfoEditBtn" style="display:none;">Info</button>
			&nbsp; <button type="button" class="btn btn-info btn-sm projectRefresh" style="display:none;">
          <span class="glyphicon glyphicon-refresh"></span>         </button>
			<!-- &nbsp;<button type="button" class="btn btn-success projectRefresh" style="display:none;">Refresh</button> -->
		</div>
		<div class="filterDataClass col-md-2 noPadding" style="display:none;"><label class="labelClass">Filter</label>
			 	<select  data-style="btn-primary" id="dreEditFilterData" class="dreEditFilterClass" name="dreEditFilterData" data-width="120px">
						<option value="-1" selected>Please select</option>
		...
		<div class="col-md-4 noPadding">
			...
			<div class="col-md-3 noPadding input-group add-on" style="float:right">
				<input class="form-control widthPercent75" placeholder="Search" id="srchTerm" type="text">
		...
		<form:form action="${saveDesignRelease}" method="POST"  id="designReleaseEditWrapper" modelAttribute="designReleaseEditWrapper">
			...
			<input type="hidden" id="projectIdEditHidden" name="projectId" value=""/><input type="hidden" id="designReleaseEditListEmpty" value="true"/>
				<div class="table-responsive">          
					...
					<div class="headerGridEditDive"><!-- class="headerGridEditDive" -->
						<table class="table designReleaseEditTable noPadding" id="dsgnEditrelease" style="white-space: nowrap !important;"width="100%" >
							<thead>
								<tr>
									<th rowspan="2" style="vertical-align: middle;" width="2%">
									<input type="checkbox" id="editallcheckbox" name="editallcheckbox" value=""/>
									
									</th>
									<th rowspan="2" ><label class="designLabelClass">Activity ID</label></th>
									<th rowspan="2" ><label class="designLabelClass">Activity Description</label></th>
									<th rowspan="2" ><label class="designLabelClass">EDOT</label></th>
									<th rowspan="2" ><label class="designLabelClass">Main Group</label></th>
									<!-- <th rowspan="2"><label class="designLabelClass">Status</label></th> -->
									<th colspan="8" ><label class="designLabelClassTopHeader">Engineering</label></th>
									<th colspan="6" ><label class="designLabelClassTopHeader">Design</label></th>
									<th rowspan="2" ><label class="designLabelClass">Auto Close?</label></th>
									<th rowspan="2"><label class="designLabelClass">Status</label></th>
								</tr>
								<tr>
									...
									<th ><label class="designLabelClass" >Engr Org Project</label></th>
									<th ><label class="designLabelClass" >Resource</label></th>
									...
									<th ><label class="designLabelClass">Date Change Reason</label></th>
									<!-- <th ><label class="designLabelClass">Group</label></th>  -->
									<th ><label class="designLabelClass">Design Org Project</label></th> 
									<th><label class="designLabelClass">Resource</label></th> 
			...
			<div class="col-md-12 padding-top20 padding-right0 padding-left0">
				<p style="float:right;">
				  <button class="btn btn-large btn-primary" id="saveDesignReleaseEdit" type="button">Update</button>
				  <button class="btn btn-large btn-primary" id="cancelDesignReleaseEdit" type="button">Delete</button>
				</p>
			</div>
		</form:form>
	</div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body projectInfoBody">
        	<div class="col-md-12 width97 borderDDD noPadding">
				...
				<div class="col-md-6 noPadding">
					<label class="labelClass" id="engrEditProductLine"></label>
				</div>
				<div class="col-md-6 noPadding backGround8FF">
