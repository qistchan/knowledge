...
import com.ge.transportation.plm.mfg.ui.CreateGetStockMaterial;
 ...
 */
public class CreateGetStockMaterialHandlers extends AbstractHandler {
	/**
	 * The constructor.
	 */
	public CreateGetStockMaterialHandlers() {
	}
		...
		try {
			...
			if((null != selectedComponents) && (selectedComponents.length == 1)) {
				...
				if((selectedComponents[0] instanceof  TCComponentFolder) || (selectedComponents[0] instanceof  TCComponentBOMLine)) {
					...
					CreateGetStockMaterial CreateGetStockMaterialObj = new CreateGetStockMaterial(window, selectedComponents);
					CreateGetStockMaterialObj.createStockMaterialItem();
				} else {
