...
set CLONE_COMMAND="%UGII_BASE_DIR%\UGMANAGER\ugmanager_clone"
...
REM QA START
REM set ACSCLI_RECIPE=-recipeId faf85020-d0b1-4b80-90c0-816d04f74d8a
REM set ACSCLI_PARTLISTRECIPE=-recipeId 2f5069cd-3488-4e30-ae93-10a16a0ac24a
REM set PDF_TEMPLATE=-pdfTemplate \\eriget3d001qv.logon.ds.ge.com\Anarak_Staging\PDFTemplate\GE_Transportation_Template.pdf
REM set PART_PDF_TEMPLATE=-pdfTemplate \\eriget3d001qv.logon.ds.ge.com\Anarak_Staging\PDFTemplate\GE_Transportation_Part_Template.pdf
...
REM set PL_FILE nxclone.pl in case Staging location of Anark and Dispatcher are to be different. Set to nxclone_shared_location.pl in case Staging location of Anark and Dispatcher are to be same e.g. PL_FILE=%~dp0\nxclone_shared_location.pl
