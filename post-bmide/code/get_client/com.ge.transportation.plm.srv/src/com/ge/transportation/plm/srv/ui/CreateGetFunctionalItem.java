...
* GET Functional Level Item Type for Services functionality 
* using the Custom UI
*
...
public class CreateGetFunctionalItem {

	private IWorkbenchWindow m_IWorkbenchWindowObj = null;
	private InterfaceAIFComponent[] m_InterfaceAIFComponentObj = null;

	public CreateGetFunctionalItem(IWorkbenchWindow p_IWorkbenchWindow, InterfaceAIFComponent[] p_InterfaceAIFComponentObj) {
	   ...
	   * creation of the GET Functional Level Item type in Teamcenter
	   * This is a part of the sBOM implementation for Services. 
	   * @param None
	   */
	public void createGetFunctional() {

		try {

			Map<Object, Object> mapParameters = new HashMap<Object, Object>();
			mapParameters.put(Constants.BusinessObjects.Properties.strObjectTypeVal, Constants.BusinessObjects.strGET6Functional);
