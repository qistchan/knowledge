...
Installation Instructions:
==========================
  - Copy the \Translators\nxtopvdirect directory and its contents from
...
=========================
  - Configuration of Translator.xml:
    Set isactive="true" in translator.xml file inside <NxToPvDirect> tag
  - Replace appropriate values for "CHANGE_ME" in nxtopvdirect.bat/sh as per
    the instructions
-------------------------------------------------------------------------
...
Usage:
======
  Go to Translator dirctory and call nxtopvdirect.bat/sh -help
Example:
  D:\Module\Translators\nxtopvdirect\nxtopvdirect.bat -help
-------------------------------------------------------------------------

Running the Translator Standalone:
==================================
 - Information for running translator standalone is provided in the Usage by
    nxtopvdirect.bat/sh -help
-------------------------------------------------------------------------
