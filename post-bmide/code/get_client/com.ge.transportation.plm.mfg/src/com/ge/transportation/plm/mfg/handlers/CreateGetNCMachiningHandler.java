...
import com.ge.transportation.plm.mfg.ui.CreateGetNCMachiningItem;
 ...
 */
public class CreateGetNCMachiningHandler extends AbstractHandler 
{
	/**
	 * The constructor.
	 */
	public CreateGetNCMachiningHandler() 
	{
	}
		...
		try {
			...
			if((null != selectedComponents) && (selectedComponents.length == 1)) {
				...
				if((selectedComponents[0] instanceof  TCComponentFolder) || (selectedComponents[0] instanceof  TCComponentBOMLine)) {
					...
					CreateGetNCMachiningItem createNCMacining = new CreateGetNCMachiningItem(window, selectedComponents);
					createNCMacining.createGetOperation();
				} else {
