	...
	<div id="body">
		<div class="row-content">
			...
			<div class="col-md-15">
						...
						<jsp:include page="UserHomeDesgnEdit.jsp"/>
		...
		<div class="modal fade"  data-keyboard=false data-backdrop=static id="templateDropDownError" role="dialog">
		    <div class="modal-dialog modal-sm vertical-align-center">
		      <div class="modal-content">
		        ...
		        <div class="modal-footer">
				    <button type="button" class="btn btn-primary templateDropDownErrorCloseBtn">Close</button>
				</div>
		      </div>
		    </div>
  		</div>
  		<div class="modal fade" data-keyboard=false data-backdrop=static  id="projectDropDownError" role="dialog">
		    <div class="modal-dialog modal-sm vertical-align-center">
		      <div class="modal-content">
		        ...
		        <div class="modal-footer">
				    <button type="button" class="btn btn-primary projectDropDownErrorCloseBtn">Close</button>
				</div>
		      </div>
		    </div>
  		</div>
		    ...
		    <div class="modal-dialog modal-sm vertical-align-center">
		      <div class="modal-content">
		        ...
		        <div class="modal-footer">
				    ...
				    <button type="button" class="btn btn-primary designExistInModalErrorClose">No</button>
				</div>
		      </div>
		    </div>
  		</div>
