...
>
  ...
  <xsl:template name="BOMReportHeader">
    ...
    <Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
      ...
      <Styles>
		...
		<Style ss:ID="cell_data1">
          <Font ss:Color="#000000"/>
          <Interior ss:Color="#EF334D" ss:Pattern="Solid"/>
        </Style>
  ...
  <xsl:template name="generateCurrentProductData">
    ...
    <Row>
      ...
      <Cell ss:StyleID="heading3">
        <Data ss:Type="String">Engineering Product Line</Data>
      </Cell>
      <Cell ss:StyleID="heading3">
        <Data ss:Type="String">Data Model</Data>
      </Cell>
      <Cell ss:StyleID="heading3">
        <Data ss:Type="String">ECCN</Data>
      </Cell>
	  <Cell ss:StyleID="heading3">
        <Data ss:Type="String">ECCN Source</Data>
      </Cell>
	  <Cell ss:StyleID="heading3">
        <Data ss:Type="String">Objective Evidence</Data>
      </Cell>
	  <Cell ss:StyleID="heading3">
        <Data ss:Type="String">CTQ</Data>
      </Cell>
	  <Cell ss:StyleID="heading3">
        <Data ss:Type="String">Crashworhiness Critical Component</Data>
      </Cell>
	  <Cell ss:StyleID="heading3">
        <Data ss:Type="String">Emissions Critical Component</Data>
      </Cell><Cell ss:StyleID="heading3">
        <Data ss:Type="String">Homologation</Data>
      </Cell>
	  <Cell ss:StyleID="heading3">
        <Data ss:Type="String">Critical Part</Data>
      </Cell>
	  <Cell ss:StyleID="heading3">
        <Data ss:Type="String">Object Weight</Data>
      </Cell>
	  <Cell ss:StyleID="heading3">
        <Data ss:Type="String">Object Weight UoM</Data>
      </Cell>
	...
	<Cell ss:StyleID="cell_data">
	  ...
	  <Cell ss:StyleID="cell_data">
        <Data ss:Type="String">
		 ...
		 <xsl:variable name="EngrProdLineRef" select="substring-after(/plm:PLMXML/plm:Design[@id=$itemRef]/plm:UserData/plm:UserValue[@title='get6EngrProdLine']/@valueRef,'#')"/>
         <xsl:variable name="EngrProdLine" select="/plm:PLMXML/plm:Text[@id=$EngrProdLineRef]/plm:Item"/>
		 <xsl:value-of select="$EngrProdLine"/>
	  ...
	  <Cell ss:StyleID="cell_data">
	   ...
	   <xsl:variable name="ECCN" select="/plm:PLMXML/plm:Design[@id=$itemRef]/plm:UserData/plm:UserValue[@title='get6ECCN']/@value"/>
	  ...
	  <Cell ss:StyleID="cell_data">
	   ...
	   <xsl:variable name="ECCNSourceRef" select="substring-after(/plm:PLMXML/plm:Design[@id=$itemRef]/plm:UserData/plm:UserValue[@title='get6ECCNSource']/@valueRef,'#')"/>
	   
	<xsl:variable name="ECCNSource" select="/plm:PLMXML/plm:Text[@id=$ECCNSourceRef]/plm:Item"/>
	  ...
	  <Cell ss:StyleID="cell_data">
	   ...
	   <xsl:variable name="ObjEvidence" select="/plm:PLMXML/plm:Design[@id=$itemRef]/plm:UserData/plm:UserValue[@title='get6ObjEvidence']/@value"/>
	  ...
	  <Cell ss:StyleID="cell_data">
	   ...
	   <xsl:variable name="CCCRef" select="substring-after(/plm:PLMXML/plm:Design[@id=$itemRef]/plm:UserData/plm:UserValue[@title='get6CCC']/@valueRef,'#')"/>
	   
	<xsl:variable name="CCC" select="/plm:PLMXML/plm:Text[@id=$CCCRef]/plm:Item"/>
         <xsl:value-of select="$CCC"/>
        </Data>
      </Cell>
	   <Cell ss:StyleID="cell_data">
        <Data ss:Type="String">	
          <xsl:variable name="ECCRef" select="substring-after(/plm:PLMXML/plm:Design[@id=$itemRef]/plm:UserData/plm:UserValue[@title='get6ECC']/@valueRef,'#')"/>
	   <xsl:variable name="ECC" select="/plm:PLMXML/plm:Text[@id=$ECCRef]/plm:Item"/>
	   ...
	   <xsl:variable name="Homologation" select="/plm:PLMXML/plm:Design[@id=$itemRef]/plm:UserData/plm:UserValue[@title='get6Homologation']/@value"/>
         <xsl:value-of select="$Homologation"/>
        </Data>
      </Cell>
	  <Cell ss:StyleID="cell_data">
        <Data ss:Type="String">	
         
	   <xsl:variable name="CriticalPart" select="/plm:PLMXML/plm:Design[@id=$itemRef]/plm:UserData/plm:UserValue[@title='get6CriticalPart']/@value"/>
         <xsl:value-of select="$CriticalPart"/>
        </Data>
      </Cell>
	   <Cell ss:StyleID="cell_data">
        <Data ss:Type="String">	
         <xsl:value-of select="$ObjWt"/>
        </Data>
      </Cell>
	   <Cell ss:StyleID="cell_data">
        <Data ss:Type="String">	
         <xsl:value-of select="$ObjWtUOM"/>
        </Data>
      </Cell>
  ...
  <xsl:template name="ChildComponentsExt">
	...
	<xsl:variable name="parentRef" select="substring-after(/plm:PLMXML/plm:ProductView/plm:Occurrence[@id=$occid]/@parentRef,'#')"/>
	<xsl:variable name="instancedRef" select="substring-after(/plm:PLMXML/plm:ProductView/plm:Occurrence[@id=$parentRef]/@instancedRef,'#')"/>
	<xsl:variable name="parentType" select="/plm:PLMXML/plm:DesignRevision[@id=$instancedRef]/@subType"/>
    <xsl:choose>
      <xsl:when test="$occRefs!=''">
        ...
        <Row >	
		  ...
		  <xsl:choose>		 
           <xsl:when test="not($ServformRef) and $object_type = 'GET6MechPartRevision' and $parentType = 'GET9FnctLvlRevision'">
			<Cell ss:StyleID="cell_data1">
				<Data ss:Type="String">
