			...
			<div class="col-md-15">
				<div class="col-md-12 container">
					<!-- <ul class="nav nav-tabs">
					    <li class="active"><a data-toggle="tab" href="#content-Main">Workflow</a></li>
					    <li><a data-toggle="tab" href="#content-ECR">ECR Assignment</a></li>
					    <li><a data-toggle="tab" href="#content-ECN">EDOT Technical Data Link</a></li>
  				...
  				<div class="tab-content">
					<div id="content-Main" class="tab-pane fade in active">
						<jsp:include page="UserHomeEngEdit.jsp"/>
					</div>
					<div id="content-ECR" class="tab-pane fade">
						<jsp:include page="UserHomeEngECR.jsp"/>
					</div>
					<div id="content-ECN" class="tab-pane fade">
						<jsp:include page="UserHomeEngECN.jsp"/>
					</div>
				</div>
