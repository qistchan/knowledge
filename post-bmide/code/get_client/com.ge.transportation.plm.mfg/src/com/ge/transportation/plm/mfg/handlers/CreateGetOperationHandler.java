...
import com.ge.transportation.plm.mfg.ui.CreateGetOperationItem;
 ...
 */
public class CreateGetOperationHandler extends AbstractHandler 
{
	/**
	 * The constructor.
	 */
	public CreateGetOperationHandler() 
	{
	}
		...
		try {
			...
			if((null != selectedComponents) && (selectedComponents.length == 1)) {
				...
				if((selectedComponents[0] instanceof  TCComponentFolder) || (selectedComponents[0] instanceof  TCComponentBOMLine)) {
					...
					CreateGetOperationItem createOperation = new CreateGetOperationItem(window, selectedComponents);
					createOperation.createGetOperation();
				} else {
