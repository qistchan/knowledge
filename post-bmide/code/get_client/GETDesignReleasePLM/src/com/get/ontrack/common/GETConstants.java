...
public class GETConstants {
	...
	public static class Query {
		...
		public static String strProjectID = "Project";
		public static String strRoleName = "Role Name";
		public static String EngrSubGroup = "EngineeringSubGroup";
		public static String EngineerResource = "Engineer";
		public static String DesignResource = "Designer";
		public static String Coordinator = "Coordinator";
		public static String strEdotID = "EDOT ID";
		public static String EngrManagerResource = "Engr Manager";
		...
		public static String queryProjectMembres = "GET Project Members";
		public static String edotQuery = "GET EDOT Revisions";
		public static String groupProjectQuery = "GET Group Project LOV";
		public static String groupProjectLovName= "LOV Name";
		public static String edotParticipantQuery = "GET EDOT Participant";
		public static String group = "Group";
		public static String role = "Role";
		public static String queryTcProject = "Projects...";
		...
		public static String projectMembers = "awp0ProjectTeamMembers";
	}
	...
	public static class BusinessObjects {
		...
		public static String wsObject 		    = "WorkspaceObject";
		...
		public static class Properties {
			...
			public static String strOwningProject 			= "owning_project";
			...
			public static String projectList 				= "project_list";
			public static String assignee 					= "assignee";
			public static String assigneeGroupRole 			= "fnd0AssigneeGroupRole";
			public static String taskType 					= "task_type";
			public static String taskTemplate 				= "task_template";
			public static String successors 				= "successors";
			public static String AliasTaskName 				= "fnd0AliasTaskName";
			public static String lovVal 					= "lov_values";
			public static String lovFilter 					= "value_filters";
			public static String lovValDesc 				= "lov_value_descriptions";
		}
	}
}
