...
public class GETNXPDFDatabaseOperation extends DefaultDatabaseOperation {
    ...
    /**
     * Method to change ownership of the generated 3D PDF dataset from dcproxy to Process Owner of the workflow
     * @throws Exception 
     */
    private void changeDatasetOwnersip(Dataset dataset) throws Exception
    {
        m_zTaskLogger.debug("Entering GETNXPDFDatabaseOperation.changeDatasetOwnersip method ...");
        
        dataset = (Dataset)SoaHelper.getProperties(dataset, GETCommon.objectNameAttr);

        DataManagementService dmService = DataManagementService.getService(SoaHelper.getSoaConnection());
        ItemRevision sourceRevision = (ItemRevision) secondaryObj;
        User user = (User) sourceRevision.get_owning_user();
        Group userGroup = (Group) sourceRevision.get_owning_group();
